...
public class Interface
{
	...
	public void menuPrincipal()
	{
		...
		//para determinar o preço final seguimos as seguintes regras de negócio:

		//	Para Notebook : preço de custo + 20%
	//		Para Impressora : preço de custo + { 20% se ppm < 20 e 30% se ppm >= 20)			
